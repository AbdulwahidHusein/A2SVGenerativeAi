...
class GenerateQuestionRequest:
    ...
    def make_request(self, number_of_questions, difficulty, mode):
        ...
        if mode == "multiple_choice":
            prompt = prompt_generator.make_multiple_choice_prompt(
                number_of_questions, multiple_choice_question_format
            )
        elif mode == "short_answer":
            prompt = prompt_generator.make_short_answer_prompt(
                number_of_questions, short_answer_question_format
            )
        else:
            prompt = prompt_generator.make_multiple_choice_prompt(
                number_of_questions, multiple_choice_question_format
